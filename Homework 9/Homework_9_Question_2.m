% Homework 9 - Question 2 - Alexander Alfakir
...
f=-13; % because f(-2)=-13 – value at initial guess
...
count = count + 1;
fprime = 3*x^2 + 3; % this will change with every different function
...
% New Code
x = 1; %initial guess changed to 1
Tol = 0.0000001; % accuracy required
count = 0; % this will count how many iterations it will take
dx=1; % this is a fake value so that the while loop will execute
f=-13; % because f(-2)=-13 – value at initial guess
